...
function renderTables(){
    ...
    availableTables.forEach(table => {
        ...
        tableDiv.innerHTML = `<img src="Mi imagen.jpg" alt="Mesa ${table.number}"><div class="table-name">Mesa ${table.number}</div>`;
...
function reserveTable(){
    ...
    if(!customerName || isNaN(tableNumber) || tableNumber < 1 || tableNumber > availableTables.length){
        alert('Por favor, ingrese un nombre válido y un número de mesa.');
        return;
    }
